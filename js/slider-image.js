...
document.addEventListener("DOMContentLoaded", function () {
  const beforeImgs = document.querySelectorAll(".before-layer-web img");
  const afterImgs = document.querySelectorAll(".after-layer-web img");
  const captions = document.querySelectorAll(".caption-web");
  const buttons = document.querySelectorAll(".newPic-web");
  const afterLayer = document.querySelector(".after-layer-web");
  const dragger = document.getElementById("dragger-web");
  const container = document.querySelector(".image-compare-web");
